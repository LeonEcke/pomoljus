...
void sinWaveAnimation(uint8_t period_time_sec, uint8_t variation_amount, void* modification_method);
...
/// @param variation_amount Maximum change.
/// @param modification_method HSV change method.
void breathAnimation(uint8_t period_time_sec, uint8_t variation_amount, void* modification_method);

/// @brief A progress bar.
/// @param progress A value `]0, 100[` representing completed percentage.
/// @param variation_amount Maximum change.
/// @param modification_method HSV change method.
void progressAnimation(uint8_t progress, uint8_t variation_amount, void* modification_method);
